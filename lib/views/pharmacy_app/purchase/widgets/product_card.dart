...
class ProductCard extends StatelessWidget {
            ...
            children: [
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          if (product.inCartMode)
                            Container(
                              ...
                              child: Row(
                                children: [Icon(Icons.remove,color: Colors.black,), const SizedBox(width: 4), const Text("1"), const SizedBox(width: 4), Icon(Icons.add ,color: Colors.black,)],
                              ),
                            ),
                        ],
                      ),
                      ...
                      product.inCartMode
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: product.prescriptionReceived ? Colors.green.shade50 : Colors.teal.shade50,
                        ),
                        child: Row(
                          spacing: 4,
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Icon(
                              ...
                              color: product.prescriptionReceived ? Colors.green : AppColors.pharmacy_PrimaryColor,
                              size: 18,
                            ),
                            ...
                            Expanded(
                              child: Text(
                                ...
                                style: TextStyle(fontSize: 12, color: product.prescriptionReceived ? Colors.green : AppColors.pharmacy_PrimaryColor),
                              ),
                            ),
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(color: AppColors.pharmacy_PrimaryColor, borderRadius: BorderRadius.circular(8)),
              ...
              if (!product.inCartMode)
                IconButton(
                  ...
                  icon: Icon(product.isBookmarked ? Icons.bookmark : Icons.bookmark_border, color: AppColors.pharmacy_PrimaryColor),
                ),
            ],
          ),
        ),
  ...
  Widget _tag(String label) => Container(
    ...
    child: Text(label, style:  TextStyle(fontSize: 12, color: AppColors.pharmacy_PrimaryColor)),
  );
}