...
class DonateCampaignCardSecond extends StatefulWidget {
  final CampaignModel campaign;

  // Constructor requires a campaign object
  const DonateCampaignCardSecond({Key? key, required this.campaign}) : super(key: key);

  @override
  State<DonateCampaignCardSecond> createState() => _CampaignCardViewState();
}

class _CampaignCardViewState extends State<DonateCampaignCardSecond> {
