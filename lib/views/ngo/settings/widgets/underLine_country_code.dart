...
class underLineCountryPicker extends StatelessWidget {
  ...
  final EdgeInsetsGeometry? margin; // Added margin parameter for external spacing

  const underLineCountryPicker({
    Key? key,
  ...
  Widget build(BuildContext context) {
    ...
    final containerHeight = height ?? (verticalSpacing.clamp(12.0, 16.0) * 2 + fontSize.clamp(14.0, 16.0) * 1.4 + 4.0);
      ...
      child: IntrinsicWidth(
        child: Column(
          ...
          children: [
            ...
            Container(
              decoration: BoxDecoration(color: backgroundColor ?? Colors.white, border: Border(bottom: BorderSide(color: Colors.black))),
              child: Material(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    padding:
                        contentPadding ??
                        EdgeInsets.symmetric(horizontal: horizontalPadding.clamp(12.0, 16.0), vertical: 2),
                    child: Row(
                      ...
                      children: [
                        ...
                        Obx(() {
                          return Text(country.value.flagEmoji, style: TextStyle(fontSize: fontSize.clamp(18.0, 20.0), height: 1.0));
                        }),
                        SizedBox(width: 6),
                        // Country code
                        Obx(() {
                          return Text(
                            ...
                            style: TextStyle(fontSize: fontSize.clamp(14.0, 16.0), color: Colors.black87, fontWeight: FontWeight.w500, height: 1.0),
                          );
                        }),
                        SizedBox(width: 4),
                        // Dropdown icon
                        Icon(
                          ...
                          size: fontSize.clamp(16.0, 20.0), // Responsive icon size
                        ),
                      ],
                    ),
                  ),
