...
Widget buildTabContent(ScrollController scrollController, controller) {
  return Obx(
    () => ListView(
      ...
      children: [
        ...
        ...controller.options.asMap().entries.map((entry) {
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              color: isSelected ? Color(0xFFFEFAF3) : Color(0xFFF7F8FC),
              ...
              border: Border(
                left: BorderSide(
                  color: isSelected ? Color(0xFFF79E1B) : Colors.transparent,
                  width: 4,
                ),
                top: BorderSide(
                  color: isSelected ? Color(0xFFF79E1B) : Colors.transparent,
                  ...
                  Container(
                    decoration: BoxDecoration(
                      gradient: const LinearGradient(
                        colors: [Color(0xFFFCCF8C), Color(0xFFF79E1B)],
